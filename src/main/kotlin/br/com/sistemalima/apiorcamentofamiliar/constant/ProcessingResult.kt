...
class ProcessingResult {
    ...
    companion object {
        ...
        const val BAD_REQUEST_EXCEPTION_MESSAGE =
            "configurações de sistema definidas incorretamente ou entradas irregulares nos elementos do sistema"
        const val BAD_REQUEST_MESSAGE_VALIDATION_EXPENSE =
            "cadastro de despesas duplicadas contendo a mesma descrição, dentro do mesmo mês"
        const val JSON_PARSE_ERROR_MESSAGE = "JSON parse error: Cannot deserialize value of type"
    }
}